...
(fset 'wealthsimple-email-to-ledger-format
      (kmacro-lambda-form [?k ?k ?k ?k ?k ?k ?I escape ?E ?x ?x
			      ?I ?I ?n ?b ?e backspace backspace
			      ?v ?e ?s ?t ?m ?e ?n ?t ?: ?W ?e ?a
			      ?l ?t ?h ?s ?i ?m ?p ?l ?e ?/ ?:
			      backspace backspace ?: escape ?I
			      tab escape ?j ?j ?j ?j ?j ?A escape
			      ?v ?B ?l ?l ?y ?k ?k ?k ?k ?k ?A
			      ?\C-u ?  escape ?p ?B ?i ?- escape
			      ?j ?j ?d ?d ?u ?I escape ?v ?E ?d
			      ?x ?v ?E escape ?B ?B ?j ?I escape
			      ?v ?$ ?b ?l escape ?I escape ?V
			      escape ?v ?$ ?b ?e ?y ?k ?k ?o ?I
			      ?n ?v ?e ?s ?t ?m ?e ?n ?t ?: ?W ?e
			      ?a ?l ?t ?h ?s ?m backspace ?i ?m
			      ?p ?l ?e ?: escape ?p ?k ?A escape
			      escape ?j ?j ?A escape ?v ?B ?B ?y
			      ?k ?k ?k ?A escape ?p escape ?j ?j
			      ?j ?j ?j ?A escape ?v ?B escape ?A
			      escape ?\C-v ?y ?k ?k ?k ?k ?k ?A ?
			      escape ?p ?j ?j ?j ?j ?A escape ?v
			      ?B ?y ?k ?k ?k ?k ?A ?  escape ?p
			      ?a ?  ?@ ?  escape ?j ?j ?j ?V ?j
			      ?j ?d ?A escape ?v ?B ?y ?k ?k ?k
			      ?k ?j ?A escape ?p ?j ?j ?j ?j ?k
			      ?V ?j ?j ?d ?d ?d ?k ?A escape ?v
			      ?B ?x ?j ?A ?\C-u ?  escape ?P ?B
			      ?x ?\C-c ?u] 0 "%d"))
