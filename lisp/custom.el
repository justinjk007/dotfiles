...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eat alarm-clock jcl-mode ob-async groovy-mode crontab-mode xref-js2 js2-refactor js2-mode auctex dashboard yaml-mode wotd smartparens flutter dart-server lsp-dart lsp-ui lsp-mode company-go go-mode anzu dockerfile-mode flycheck-ledger ledger-mode expand-region hungry-delete evil-goggles beacon counsel-projectile ibuffer-projectile projectile avy counsel swiper rainbow-delimiters highlight-numbers key-chord htmlize speed-type ivy-yasnippet yasnippet-snippets yafolding prettier web-mode engine-mode doom-modeline minions nerd-icons shackle olivetti academic-phrases markdown-mode csv-mode ox-hugo ox-reveal ox-twbs org-bullets ox-mediawiki orgmode-mediawiki indent-bars treesit-auto evil-markdown cmake-project cmake-mode clang-format modern-cpp-font-lock auto-virtualenvwrapper perltidy org-contrib orgalist ansible flyspell-popup flyspell-correct evil flycheck rainbow-mode yasnippet emmet-mode))
