...
(custom-set-faces
 ...
 '(spaceline-evil-emacs ((t (:background "#6c71c4" :foreground "#fdf6e3" :inherit (quote mode-line)))))
 '(spaceline-evil-insert ((t (:background "#859902" :foreground "#fdf6e3" :inherit (quote mode-line)))))
 '(spaceline-evil-motion ((t (:background "#268bd2" :foreground "#fdf6e3" :inherit (quote mode-line)))))
 '(spaceline-evil-normal ((t (:background "#268bd2" :foreground "#fdf6e3" :inherit (quote mode-line)))))
 '(spaceline-evil-replace ((t (:background "chocolate" :foreground "#fdf6e3" :inherit (quote mode-line)))))
 '(spaceline-evil-visual ((t (:background "#2AA198" :foreground "#fdf6e3" :inherit (quote mode-line)))))
